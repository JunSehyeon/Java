...
public class Main {
	public static void main(String[] args) {
		// 과목 생성
		Subject java = new Subject("자바", new Student[10], 0);
		Subject database = new Subject("데이터베이스", new Student[10], 0);
		// 학생 생성
		Student student1 = new Student("김유신", "S001", new Subject[5], new int[5], 0);
		Student student2 = new Student("김춘추", "S002", new Subject[5], new int[5], 0);
		// 학생 과목 수강 신청
